                                                ...
                                                <td>
                                                    <span class="badge bg-<?php 
                                                        switch ($reporte['Evento']) {
                                                            case 'Incendio': echo 'danger'; break;
                                                            case 'Fuga gas': echo 'warning'; break;
                                                            case 'Rescate animal': echo 'success'; break;
                                                            default: echo 'info';
                                                        }
                                                    ?>">
                                                ...
                                                <td>
                                                    <span class="badge bg-<?php 
                                                        switch ($reporte['Estatus']) {
                                                            ...
                                                            case 'En proceso': echo 'info'; break;
                                                            case 'Atendido': echo 'success'; break;
